            ...
            <div key={product.id} className="product-card">
              ...
              <div className="product-image">
                ...
                <div className="product-badges">
                  {product.isNew && (
                    <span className="product-badge product-new-badge">{t('new_arrivals.new')}</span>
                  )}
                  {product.discountPercentage && (
                    ...
                    {product.isBestSeller && (
                      <span className="product-badge bestseller-badge">{t('new_arrivals.bestseller')}</span>
                    )}
                </div>
              ...
              <div className="product-info">
                ...
                >
                  ...
                  <span className="button-text">{t('new_arrivals.add_to_cart')}</span>
                </button>
              </div>
            </div>
            );
