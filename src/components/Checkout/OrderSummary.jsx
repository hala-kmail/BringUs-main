          ...
          {isProcessing ? (
            <span className="processing">
              {deliveryMethod === 'store' 
                ? (currentLang === 'ar' ? 'جاري إنشاء الطلب وإرساله للواتساب...' : 'Creating order and sending to WhatsApp...')
            ...
            <>
              ...
              {deliveryMethod === 'store' 
                ? (currentLang === 'ar' ? 'إنشاء الطلب وإرساله للواتساب' : 'Create Order & Send to WhatsApp')
